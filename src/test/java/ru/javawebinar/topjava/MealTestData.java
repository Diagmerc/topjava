...
public class MealTestData {
    ...
    public static final MatcherFactory.Matcher<MealTo> MEAL_MATCHER_TO = MatcherFactory.usingIgnoringFieldsComparator(MealTo.class);
    ...
    public static final List<Meal> allMeals = List.of(meal7, meal6, meal5, meal4, meal3, meal2, meal1, adminMeal1, adminMeal2);
